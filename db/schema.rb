...
ActiveRecord::Schema[8.1].define(version: 2026_03_11_000008) do
  ...
  create_table "products", force: :cascade do |t|
    ...
    t.string "emoji"
    t.string "image_url"
    t.boolean "is_customizable", default: false, null: false
    ...
    t.index ["shift"], name: "index_products_on_shift"
  end
