...
cat_almoco = Category.find_or_create_by!(name: "Almoço Executivo",      position: 1, emoji: "🍱")
cat_frango = Category.find_or_create_by!(name: "Frangos Assados",       position: 2, emoji: "🍗")
cat_pizza  = Category.find_or_create_by!(name: "Pizzas Tradicionais",   position: 3, emoji: "🍕")
cat_bebida = Category.find_or_create_by!(name: "Bebidas",               position: 4, emoji: "🥤")
